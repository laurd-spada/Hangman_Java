...
public class StartGameImp implements StartGame {
    private int no_lives= 10;
...
//        String[] word_list = {"car", "apple", "camel", "dog", "car", "horse", "toad", "cup","bag", "tea", "fire", "air",};
        ...
        int wordIndex =(int) (Math.random() * words.word_list.length);
        String secret_Word = words.word_list[wordIndex];
